...
const InitialContainer = () => {
    ...
    return <Container className="information-container" disableGutters component="main" maxWidth={false} sx={{ display: "flex", alignItems: "flex-end", m: 0, pt: 8, pb: 0, backgroundImage: "url(/images/Piscina_2.jpeg)", minHeight: "100vh", backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
